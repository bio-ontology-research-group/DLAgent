...
public class LabelShortFormProvider implements BidirectionalShortFormProvider {
    ...
    *            taken. For a given entity, all ontologies are examined. */
    ...
    public LabelShortFormProvider(Set<OWLOntology> ontologies) {
        this(Collections.singletonList(
            OWLManager.getOWLDataFactory().getOWLAnnotationProperty(
                OWLRDFVocabulary.RDFS_LABEL.getIRI())),
        Collections.emptyMap(),
        new SimpleOntologySetProviderImpl(ontologies))
    }

    public LabelShortFormProvider(
    ...
    *            the alternate IRI short form provider */
    public LabelShortFormProvider(
            ...
            Map<OWLAnnotationProperty, List<String>> preferredLanguageMap) {
        this(ontologySetProvider, alternateShortFormProvider,
            alternateIRIShortFormProvider, annotationProperties, preferredLanguageMap,
            new OWLAnnotationValueVisitorsExNew())
    }
